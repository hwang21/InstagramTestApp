...
public class ZoomImageView extends ImageView {
	...
	public void setupPinchZoom() {
		...
		// set the size of the picture to fit the smallest orientation of the
		// screen
		if (width > height) {
		...
		// create a transformation matrix and set the scale and translation
	...
	public void onDraw(Canvas canvas) {
		...
		if (draw != null) {
			// draw a bitmap with the desired scaling and translate the canvas
			// to pan
